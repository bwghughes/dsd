...
SECRET_KEY = "django-insecure-w94d9nes!z_a^s(y+6l7+s71d^_5!j@8)t%^hrwhysw)h)k5=!"
...
if os.environ.get("ON_FLYIO"):
    ...
    ALLOWED_HOSTS.append('late-star-8361.fly.dev')
    ...
    CSRF_TRUSTED_ORIGINS = ['https://late-star-8361.fly.dev']
